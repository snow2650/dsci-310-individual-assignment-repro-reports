...
```{r,out.width="80%",fig.cap= "Horse populations for all provinces in Canada from 1906 - 1972",fig.align = 'center'}
...
```{r, out.width="80%",fig.cap= "Horse populations for the province with the largest standard deviation",fig.align = 'center'}
...
In Figure 2 we zoom in and look at the province of 'rrow(largest_sd)?', which had the largest spread of values in terms of standard deviation.
